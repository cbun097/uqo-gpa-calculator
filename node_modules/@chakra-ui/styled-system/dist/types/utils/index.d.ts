 ...
 */
export declare function polyfill<T extends keyof CSS.Properties>(map: {
    ltr: T | T[];
    rtl: T | T[];
}): (value: any, scale: any, props: any) => any;
export declare function handleQuartetValues(value: string): string;
export declare const isRtl: (theme: any) => boolean;
